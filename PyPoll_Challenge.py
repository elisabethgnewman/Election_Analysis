...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_turnout:
        ...
        turnout_percentage = float(turnout) / float(total_turnout) * 100
        county_results = (
        ...
        if (turnout > winning_turnout) and (turnout_percentage > winning_turnout_percentage):
            winning_turnout = turnout
            winning_county = county_name
            winning_turnout_percentage = turnout_percentage
